...
// WiFi Credentials
const char* ssid = "Nayatel-2.4G";
const char* password = "03181070558";

// Firebase Configuration
const String FIREBASE_HOST = "lab-11-practice-default-rtdb.firebaseio.com";
const String FIREBASE_AUTH = "5YAOUolkcAjaHrGhcLUU9KXif14pGjD3L08mcL4E";
const String FIREBASE_PATH = "/sensor_data_1363.json";
