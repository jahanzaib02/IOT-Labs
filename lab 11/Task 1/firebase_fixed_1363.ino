...
const String FIREBASE_HOST = "iot-lab-11-1363-default-rtdb.firebaseio.com";
const String FIREBASE_AUTH = "LWMKKEIXcZaYfHKh8LEyUid3QlsHVb9t5LEnNqkW";
const String FIREBASE_PATH = "/sensor_data_1363.json";

// DHT Sensor
#define DHTPIN 3       // GPIO4 (change if needed)
